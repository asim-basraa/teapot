...
//
// Regenerate the Post-it space migration:
...
const HOME = `Post-it is a knowledge garden with real access control. Ordinary
...
const CONNECT = `Post-it speaks MCP, so Claude can read and write the pages you
...
const lines: string[] = [];
lines.push(`-- The Post-it space: the product's own documentation, as content.
--
...
lines.push(page("Post-it", "index", HOME, null));
